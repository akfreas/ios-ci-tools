...
os.system("security import %s/iPhone-distribution.cer -k ~/Library/Keychains/ios-build.keychain -T /usr/bin/codesign")
os.system("security import %s/iPhone-distribution.p12 -k ~/Library/Keychains/ios-build.keychain -p %s -T /usr/bin/codesign" % key_password)
